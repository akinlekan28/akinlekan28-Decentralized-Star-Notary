...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.name.call(), "Bright Star");
    assert.equal(await instance.symbol.call(), "BS");
});
...
it('lets 2 users exchange stars', async() => {
    ...
    let tokenId2 = 8;
    let instance = await StarNotary.deployed();
    await instance.createStar('Neon Star', tokenId1, { from: accounts[0] });
    await instance.createStar('Donep Star', tokenId2, { from: accounts[1] });
...
it('lets a user transfer a star', async() => {
    ...
    let tokenId = 9;
    let instance = await StarNotary.deployed();
    await instance.createStar('Deep Star', tokenId, { from: accounts[0] });
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    const star = await instance.lookUptokenIdToStarInfo.call(tokenId);
